...
export class ApiStack extends cdk.Stack {
  ...
  private async init(_: Construct, id: string, props: ApiProps): Promise<void> {
    ...
    new cdk.CfnOutput(this, 'apiURL', { value: api.attrApiEndpoint });
  ...
  private async createAPIAndStage(params: {
    ...
    (apiDefinition.servers ?? []).forEach((x: any): void => {
      x['x-amazon-apigateway-endpoint-configuration'] = { disableExecuteApiEndpoint: true };
    });
